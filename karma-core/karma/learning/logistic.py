...
def logistic_coefficients_lbfgs(X, y, max_iter, C=1e10, w_warm=None, sample_weight=None, nb_threads=1):
    ...
    try:
        w0, _, _ = fmin_l_bfgs_b(logistic_loss_and_grad, w_warm, fprime=None,
    ...
    return linear_pred, intercept, betas
...
def logistic_coefficients(X, y, max_iter, solver='liblinear', C=1e10,
    ...
    if solver != 'lbfgs':
        ...
        linear_pred, intercept, beta = logistic_coefficients_lbfgs(X, y, max_iter=max_iter, C=C,
                                                                   w_warm=w_warm,
